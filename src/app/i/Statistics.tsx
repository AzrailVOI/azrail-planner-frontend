...
export default function Statistics({}: IStatistics) {
		...
		<div className={'grid grid-cols-4 gap-12 mt-7'}>
			{data?.statistics.length ? (
				data.statistics.map(statistic => (
					<div
						className='bg-border/5 rounded p-layout text-center hover:-translate-y-2 transition-transform duration-500'
						key={statistic.label}
					>
